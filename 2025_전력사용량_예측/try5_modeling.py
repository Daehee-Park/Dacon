...
predictor.fit(train_data=preprocessed_train_df, presets='best_quality',time_limit=3600*12,full_weighted_ensemble_additionally=True,dynamic_stacking=True,
            auto_stack=True,num_bag_folds=8,num_stack_levels=1,num_gpus=1,refit_full=True)
...
dacon_submit(
    ...
    memo=f'Regression: Imputed sunshine/solar for test, Feature engineering, log transform, building-hour avg features, AutoGluon 6Hrs 5CV: {best_cv_score}'
)
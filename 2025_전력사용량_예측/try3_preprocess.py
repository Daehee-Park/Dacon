...
train_processed.to_csv('output/try3/preprocessed_train.csv', index=False)

test_processed = pd.DataFrame(X_test_processed, columns=preprocessor.get_feature_names_out())
test_processed.to_csv('output/try3/preprocessed_test.csv', index=False)

logger.info("Saved preprocessed data to output/try3/")
